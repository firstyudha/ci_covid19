			...
			<div class="container">
				...
				<nav class="main-nav float-right d-none d-lg-block">
					<ul>
						...
						<li><a href="<?= base_url('Covid/covidMap') ?>" target="_blank">Global Maps <span
									class="badge badge-success">Updated</span></a></li>
					</ul>
				</nav><!-- .main-nav -->
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
							<div class="member">
								<img src="<?= base_url() ?>assets/assets/img/yudha.jpg" style="height:250px"
									class="img-fluid" alt="">
								<div class="member-info">
									<div class="member-info-content">
										<h4>Yudha Pratama</h4>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 footer-info">
							...
							<img src="<?= base_url() ?>assets/assets/img/coronation.png" width=250 class="img-fluid"
								alt="">
							<b>
								<p class="mt-2">
