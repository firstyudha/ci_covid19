...
<head>
  ...
  <link href="<?= base_url() ?>assets/assets/vendor/owl.carousel/<?= base_url() ?>assets/assets/owl.carousel.min.css" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container">
      ...
      <div class="logo float-left">
        ...
        <h2><span><img src="<?= base_url() ?>assets/assets/img/coronation.png" alt="" class="img-fluid mr-2">coronation</span></h2>
      </div>
  ...
  <section id="intro" class="clearfix">
    <div class="container">
      ...
      <div class="intro-img">
        <img src="<?= base_url() ?>assets/assets/img/coronation.png" alt="" class="img-fluid rounded-circle shadow-lg" width=400>
      </div>
        ...
        <div class="row about-container">
          ...
          <div class="col-lg-5 offset-lg-1 content order-lg-1 order-2">
            ...
            <div class="icon-box wow fadeInUp">
              ...
              <p class="description"><span class="counters h1" data-toggle="counter-up"><?= $i['positif'] ?></span></p>
            </div>

            <div class="icon-box wow fadeInUp" data-wow-delay="0.4s">
              <div class="icon"><i class="fas fa-heart"></i></div>
              <h4 class="title"><a href="">Recovered</a></h4>
              <p class="description"><span class="counters h1" data-toggle="counter-up"><?= $i['sembuh'] ?></span></p>
            </div>
        ...
        <div class="col-lg-6 background order-lg-2 order-1 wow fadeInUp">
          ...
          <div class="col-lg-5 offset-lg-1 content order-lg-1 order-2">
            ...
            <div class="icon-box wow fadeInUp">
              <div class="icon"><i class="fas fa-viruses"></i></div>
              <h4 class="title"><a href="">Confirmed</a></h4>
              <p class="description"><span class="counters h1" data-toggle="counter-up"><?= $positif['value'] ?></span></p>
            </div>

            <div class="icon-box wow fadeInUp" data-wow-delay="0.4s">
              <div class="icon"><i class="fas fa-heart"></i></div>
              <h4 class="title"><a href="">Recovered</a></h4>
              <p class="description"><span class="counters h1" data-toggle="counter-up"><?= $sembuh['value'] ?></span></p>
            </div>

            <div class="icon-box wow fadeInUp" data-wow-delay="0.2s">
              <div class="icon"><i class="fas fa-procedures"></i></div>
              <h4 class="title"><a href="">Deaths</a></h4>
              <p class="description"><span class="counters h1" data-toggle="counter-up"><?= $meninggal['value'] ?></span></p>
            </div>
    ...
    <section id="team">
      <div class="container">
        <div class="section-header">
          <h3>Collaboration UPI x LP3I</h3>
          <br>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="member">
              <img src="<?= base_url() ?>assets/assets/img/indah.jpeg" style="height:250px" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div class="member">
              <img src="<?= base_url() ?>assets/assets/img/yudha.png" style="height:250px"  class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Yudha Pratama</h4>
