                        ...
                        <div class="icon-box wow fadeInUp centered">
                            <center>
                                ...
                                <button type="button" class="btn btn-primary" data-container="body"
                                    ...
                                    data-content="Laki-laki <?= $positifL ?> Perempuan <?= $positifP ?>">
                                    lihat detail
                                </button>
                            </center>
                    ...
                    <div class="col-md-4">
                        <div class="icon-box wow fadeInUp centered">
                            <center>
                                ...
                                <button type="button" class="btn btn-primary" data-container="body"
                                    data-toggle="popover" data-placement="right"
                                    data-content="Laki-laki <?= $meninggalL ?> Perempuan <?= $meninggalP ?>">
                                    lihat detail
                                </button>
                            </center>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="icon-box wow fadeInUp centered">
                            <center>
                                ...
                                <button type="button" class="btn btn-primary" data-container="body"
                                    data-toggle="popover" data-placement="right"
                                    data-content="Laki-laki <?= $sembuhL ?> Perempuan <?= $sembuhP ?>">
                                    lihat detail
                                </button>
                            </center>
                        </div>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-warning">
                                                            <h5 class="modal-title" id="exampleModalLongTitle">Orang
                                                                Dalam Pantauan per Jenis Kelamin</h5>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-danger text-white">
                                                            <h5 class="modal-title" id="exampleModalLongTitle">Pasiem
                                                                Dalam Pengawasan per Jenis Kelamin</h5>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
